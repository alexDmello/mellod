      ...
      <div className="flex items-center justify-between pb-4 border-b border-emerald-700/40 mb-4 relative z-10">
        <div className="flex items-center gap-3">
          {showBack && (
            <button
              onClick={() => router.back()}
              className="w-8 h-8 rounded-xl bg-white/10 hover:bg-white/20 backdrop-blur-md flex items-center justify-center transition-colors border border-white/15 mr-1"
              aria-label="Go back"
            >
