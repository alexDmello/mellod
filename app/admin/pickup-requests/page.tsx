...
export default function AdminPickupRequestsPage() {
  ...
  return (
    <div className="space-y-6 pb-12 font-sans text-slate-900">
      {/* Top Header */}
      <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 bg-white p-6 rounded-3xl border border-slate-100 shadow-xl shadow-slate-200/50">
        <div>
          <span className="px-2.5 py-0.5 rounded-full bg-emerald-50 text-emerald-700 border border-emerald-200 text-[10px] font-extrabold uppercase tracking-wider">
            FBO On-Demand Logistics
          </span>
          <h1 className="text-2xl font-black text-slate-900 tracking-tight mt-1">
            FBO Pickup Requests
          </h1>
          <p className="text-xs text-slate-500 font-medium">
            Review oil collection requests from FBO partners and schedule pickers.
          </p>
        </div>
      ...
      {/* Success Alert */}
      {actionSuccessMsg && (
        <div className="bg-emerald-50 border border-emerald-200 text-emerald-900 p-3.5 rounded-2xl text-xs font-semibold flex items-center justify-between shadow-xs animate-fade-in">
          <div className="flex items-center gap-2">
